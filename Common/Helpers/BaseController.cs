...
namespace Common.Helpers
{
    public class BaseController : Controller
    {
        ...
        public int maxFileSizeInBytes = 100 * 1024 * 1024; // 100 MB
        ...
        public static Languges CurrentLanguage
        {
            get;
            set;
        ...
        public HttpResponseMessage SendSMS(string Body, string MobileNumber, char lang = 'e', string countryCode = "962")
        {
            ...
            string mobilenumber = !(MobileNumber.StartsWith("20") || MobileNumber.StartsWith("962")) ? countryCode + (MobileNumber.StartsWith("0") ? MobileNumber.TrimStart('0') : MobileNumber) : MobileNumber;
            ...
            if (countryCode == "20")
            {
                ...
                const string password = "M^Q@5dq}B@_MohammadAbuHammad"; //Password is: M^Q@5dq}B@
                string smsText = "";
                try
                {
            ...
            else if (countryCode == "962")
            {
                ...
                const string AccName = "masera";
                //const string AccPass = "O7!oH8!DxF9";
                const string AccPass = "ENmS7W94OR__U!0c_MohammadAbuHammad"; //Password is: ENmS7W94OR__U!0c
                using (var client = new HttpClient())
                {
                    client.BaseAddress = new Uri(baseUri);
        ...
        [HttpPost]
        public JsonResult AddPushNotification(string notificationText, string type, int sectionId)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(ConnectionString.ConnStr()))
                {
                    ...
                    {
                        case "Homework":
                            notificationTypeId = (int)NotificationsTypes.Homework;
                            break;
                        case "Exam":
                            notificationTypeId = (int)NotificationsTypes.Exam;
                            break;
                        case "Attendance":
                            notificationTypeId = (int)NotificationsTypes.Attendance;
                            break;
                        default:
                            return Json(new { Success = false, Message = "Not allowed Notification Type" }, JsonRequestBehavior.AllowGet);
                    }
