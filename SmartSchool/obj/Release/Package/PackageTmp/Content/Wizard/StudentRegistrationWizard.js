$(document).ready(function () {
    ...
    StudentInfonextBtn.click(function () {
        ...
        debugger;
        //Hamza01
        if ($("#student_NationalNumber").val().length < 1) {
            $("#student_NationalNumber").attr("required", "required");
            $.toast({
                heading: 'الرجاء ادخال الرقم الوطني (القومي) !',
                text: '',
                position: 'top-center',
                loaderBg: '#ff6849',
                icon: 'error',
        ...
        else if ($("#profileImage").attr('src').includes('camera2.png') && $("#fileuploader").get(0).files.length === 0)
        {
            debugger;
            $.toast({
        ...
        //Hamza01
        else if ($("#BCPImage").attr('src').includes('BrithCertificate.jpeg') && $("#BCPfileuploader").get(0).files.length === 0) {
            debugger;
            $.toast({
        ...
        else if ($("#FBPImage").attr('src').includes('FamilyBook.jpeg') && $("#FBPfileuploader").get(0).files.length === 0) {
            debugger;
            $.toast({
        ...
        else if ($("#LYCImage").attr('src').includes('LastYearCertificate.jpeg') && $("#LYCfileuploader").get(0).files.length === 0) {
            debugger;
            $.toast({
        ...
        if (isValid) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.Success) {
                        $("#Nextstepone").attr("disabled", "disabled")
                        $.toast({
    ...
    SchoolInfonextBtn.click(function () {
        ...
        if (isValid) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.Success) {
                        $("#Nextsteptwo").attr("disabled", "disabled")
                        $.toast({
                            text: 'تمت عملية الحفظ بنجاح',
                            position: 'top-center',
                            loaderBg: '#ff6849',
    ...
    ParentsInfonextBtn.click(function () {
        ...
        if (isValid) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.Success) {
                        $("#Nextstepthree").attr("disabled", "disabled")
                        $.toast({
                            text: 'تمت عملية الحفظ بنجاح',
                            position: 'top-center',
                            loaderBg: '#ff6849',
    ...
    AddressInfonextBtn.click(function () {
        ...
        if (isValid) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.Success) {
                        $("#Nextstepfour").attr("disabled", "disabled")
                        $.ajax({
                            type: "GET",
        ...
        if (isValid) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    debugger;
                    if (response.Success) {
                        $("#Nextstepfive").attr("disabled", "disabled")
                        $.toast({
                            text: 'تمت عملية الحفظ بنجاح',
                            position: 'top-center',
                            loaderBg: '#ff6849',
    ...
    SocialnextBtn.click(function () {
        ...
        if (isValid) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.Success) {
                        $("#Nextstepsix").attr("disabled", "disabled")
                        $.toast({
                            text: 'تمت عملية الحفظ بنجاح',
                            position: 'top-center',
                            loaderBg: '#ff6849',
    ...
    HealthInfonextBtn.click(function () {
        ...
        if (isValid) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.Success) {
                        $("#Nextstepseven").attr("disabled", "disabled")
                        Swal.fire(
