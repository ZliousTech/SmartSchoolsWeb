<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditQuestion.aspx.cs" Inherits="SmartSchool.questionsweb.EditQuestion" ValidateRequest="false" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="Hdqgid" runat="server" />
        <asp:HiddenField ID="HdIsThereStudentsAnsweredTheQuestion" runat="server" />
        ...
        <main class="body-container">
            <div class="inner-row">
                ...
                <div class="head-body-col">
                    <span>
                        <!-- back  icon-->
                        <a href="ViewQuestions.aspx?FGID=<%=hdfgid.Value %>" style="color: #fff"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                        <%--<a onclick="goBack()" style="color: #fff"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>--%>
                    </span>
                    <h2><%=Resources.Resource.EditQuestion %></h2>
                </div>
