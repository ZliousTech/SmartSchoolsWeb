<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewStudentsGrades.aspx.cs" Inherits="SmartSchool.questionsweb.ViewStudentsGrades" %>
        ...
        <main class="body-container">
            <div class="inner-row">
                ...
                <div class="head-body-col">
                    ...
                    <h2><%=Resources.Resource.StudentsGrades %></h2>
                </div>
                                    ...
                                    <asp:Repeater ID="ReptFormsQuestionsList" runat="server">
                                        <ItemTemplate>
                                            <tr scope="row">
                                                ...
                                                <td class="center">
                                                    <a class="btn btn-info btn-xs" href="StudentsGradesList.aspx?FGID=<%# Eval("FormGuidID") %>"><%=Resources.Resource.View%></a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
