<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentsGradesList.aspx.cs" Inherits="SmartSchool.questionsweb.StudentsGradesList" %>
        ...
        <main class="body-container">
            <div class="inner-row">
                ...
                <div class="head-body-col">
                    <span>
                        <!-- back  icon-->
                        <a href="ViewStudentsGrades.aspx" style="color: #fff"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                    </span>
                            ...
                            <table class="table" id="exportTable" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><%=Resources.Resource.TotalFormGrades %></th>
                                        <th><%=Resources.Resource.StudentDeservedGrade %></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <asp:Repeater ID="ReptStudentsGradesList" runat="server">
                                        <ItemTemplate>
                                            <tr scope="row">
                                                <td><%# Eval("StudentName") %></td>
                                                <td><%# Eval("QuestionsGrade") %></td>
                                                <td><%# Eval("QuestionsDeservedGrade") %></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </tbody>
