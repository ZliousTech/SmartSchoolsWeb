<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSettings.aspx.cs" Inherits="SmartSchool.questionsweb.AddSettings" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="hdallstds" runat="server" />
...
<%--        <button onclick="topFunction()" id="scroll-btn" title="Go to top">
        ...
        <main class="body-container">
            <div class="inner-row">
                ...
                <div class="head-body-col">
                    <span>
                        <!-- back  icon-->
                        <a href="FormsSettings.aspx" style="color: #fff"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                        <%--<a onclick="goBack()" style="color: #fff"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>--%>
                    </span>
                    <h2><%=Resources.Resource.AddEditFormSettings %></h2>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TxtDate" runat="server" class="form-control" type="date"></asp:TextBox> <%--W3Schools Library--%>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TxtTime" runat="server" class="form-control" type="time"></asp:TextBox> <%--W3Schools Library--%>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TxtEndTime" runat="server" class="form-control" type="time"></asp:TextBox> <%--W3Schools Library--%>
                            </div>
                        </div>

                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label"><%=Resources.Resource.Students %></label>
                                <asp:DropDownList ID="DrpStudentsSelections" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DrpStudentsSelections_IndxChange" class="form-control select2"></asp:DropDownList>
                            </div>
                        </div>

                        <div class="col-md-1">
                            <div class="form-group">
                                <label class="control-label"><%=Resources.Resource.IsActive %></label><br />
                                <asp:CheckBox ID="ChkIsActive" runat="server" Checked="false" Text="Yes" />
                            </div>
                        </div>
                    </div>
                </div>

                <div class="light-component inner" id="DivStudentsSelection" runat="server">
                    <div class="col-md-12">
                        <asp:Panel ID="PnlChks" runat="server">
                            <div class="table-responsive">
                                <table class="table" id="exportTable" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th><%=Resources.Resource.Select %></th>
                                            <th><%=Resources.Resource.StudentNo %></th>
                                            <th><%=Resources.Resource.StudentName %></th>
                                        </tr>
                                    </thead>
                                    <tbody id="tBodyStds" runat="server">
                                    </tbody>
                                </table>
                                </>
                            </div>
                ...
                <div class="light-component inner">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <asp:Button ID="BtnSave" runat="server" Text="Save and continue to add questions" OnClick="BtnSave_Click" class="btn btn-primary" />
                        </div>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function () {
                $("#DrpStudentsSelections").on("change", function () {
