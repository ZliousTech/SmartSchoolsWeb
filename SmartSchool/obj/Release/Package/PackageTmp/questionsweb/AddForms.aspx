<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddForms.aspx.cs" Inherits="SmartSchool.questionsweb.AddForms" MaintainScrollPositionOnPostback="true" %>
...
<%--        <button onclick="topFunction()" id="scroll-btn" title="Go to top">
        ...
        <main class="body-container">
            <div class="inner-row">
                ...
                <div class="head-body-col">
                    ...
                    <h2><%=Resources.Resource.AddNewQuestionsForm %></h2>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><%=Resources.Resource.QuestionsFormStyle %></label>
                                <asp:DropDownList ID="DrpQuestionsFormStyles" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DrpQuestionsFormStyles_IndxChange" class="form-control select2"></asp:DropDownList>
                            </div>
                        </div>

                        <div class="col-md-8">
                            <div class="form-group">
                                <label style="font-size: small; color: orangered;"><%=Resources.Resource.Note %></label><br />
                                <asp:Label ID="LblQuestionsFormStyles" runat="server" style="font-size: small; color: limegreen;"></asp:Label>
                            </div>
                        </div>
                    </div>

                    <div id="DivTimeForQuestionsForm" runat="server" class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-8"><hr style="border: 1px solid orangered;" /></div>
        ...
        <script>
            $(document).ready(function () {
                $("#DrpQuestionsFormStyles").on("change", function () {
