<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="guginf.aspx.cs" Inherits="SmartSchool.luginf.guginf" %>
        ...
        <main class="body-container">
            <div class="inner-row">
                ...
                <div class="head-body-col">
                    <span>
                        <!-- back  icon-->
                        <a href="/Student" style="color: #fff"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                        <%--<a onclick="goBack()" style="color: #fff"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>--%>
                    </span>
                    <h2><%=Resources.Resource.LinksForUpdateStudentsLocation %></h2>
                </div>
                            ...
                            <table class="table" id="exportTable" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><%=Resources.Resource.LinksForUpdateStudentsLocation %></th>
                                        <th><%=Resources.Resource.Actions %></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <asp:Repeater ID="ReptStudentsSchoolList" runat="server" OnItemDataBound="OnItemDataBound">
                                        <ItemTemplate>
                                            <tr scope="row">
                                                <td><%# Eval("StudentName") %></td>
                                                <td id="CellLinkItem" runat="server"></td>
                                                <td></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
