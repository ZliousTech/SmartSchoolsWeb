...
{
    public partial class CorrectionStudentAnswers : System.Web.UI.Page
    {
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < QuestionGuidIDsGrads.Length - 1; i++)
            {
                ...
                string InsertRes = InsertStudentQuestionAnswer(QuestionGradeGuidID, StudentID, FormGuidID, QuestionGuidID, 
        ...
        private string InsertStudentQuestionAnswer(string QuestionGradeGuidID, string StudentID, string FormGuidID, string QuestionGuidID, 
                                                   double QuestionGrade, double QuestionDeservedGrade)
        {
            ...
            CMD = new SqlCommand("INSERT INTO QuestionStudentsDeservedGrade " +
                                 "(" +
                                    "QuestionGradeGuidID, StudentID, FormGuidID, QuestionGuidID, QuestionGrade, QuestionDeservedGrade " +
                                 ") VALUES (" +
                                    "@QuestionGradeGuidID, @StudentID, @FormGuidID, @QuestionGuidID, @QuestionGrade, @QuestionDeservedGrade " +
                                 ")", con);
            CMD.Parameters.AddWithValue("@QuestionGradeGuidID", QuestionGradeGuidID);
