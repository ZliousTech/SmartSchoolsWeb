<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentsList.aspx.cs" Inherits="SmartSchool.questionsweb.StudentsList" %>
        ...
        <main class="body-container">
            <div class="inner-row">
                ...
                <div class="head-body-col">
                    <span>
                        <!-- back  icon-->
                        <a href="CorrectingAnswers.aspx" style="color: #fff"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                    </span>
                    <h2><%=Resources.Resource.StudentsList %></h2>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table" id="exportTable" style="width: 100%">
                                ...
                                <tbody>
                                    <asp:Repeater ID="ReptQuestionsList" runat="server">
                                        <ItemTemplate>
                                            <tr scope="row">
                                                <td><%# Eval("StudentName") %></td>
                                                <td>
                                                    <%#Eval("IsThereDeservedGrade").ToString() == "0"
                                                            ?
                                                            ""+Resources.Resource.NotYet+""
                                                            :
                                                            ""+Resources.Resource.Corrected+""
                                                    %>
                                                </td>
                                                <td class="center">
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <%#Eval("IsThereDeservedGrade").ToString() == "0"
                                                                        ?
                                                                        "<a class='btn btn-info btn-xs' href='CorrectionStudentAnswers.aspx?FGID="+hdfgid.Value+"&STDID="+Eval("StudentID")+"&n="+Eval("StudentName")+"'>"+Resources.Resource.CorrectionStudentAnswers+"</a>" 
                                                                        :
                                                                        "<a class='btn btn-success btn-xs' href='javascript:0'>"+Resources.Resource.CorrectionStudentAnswers+"</a>"
                                                                %>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <%#Eval("IsThereDeservedGrade").ToString() == "0"
                                                                        ?
                                                                        "<a class='btn btn-danger btn-xs' href='javascript:0'>"+Resources.Resource.EditCorrectionStudentAnswers+"</a>"
                                                                        :
                                                                        "<a class='btn btn-warning btn-xs' href='EditCorrectionStudentAnswers.aspx?FGID="+hdfgid.Value+"&STDID="+Eval("StudentID")+"&n="+Eval("StudentName")+"'>"+Resources.Resource.EditCorrectionStudentAnswers+"</a>" 
