<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormsView.aspx.cs" Inherits="SmartSchool.questionsweb.FormsView" %>
        ...
        <main class="body-container">
            <div class="inner-row">
                ...
                <div class="head-body-col">
                    ...
                    <h2><%=Resources.Resource.FormsView %></h2>
                </div>
                            ...
                            <table class="table" id="exportTable" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <%--<th><%=Resources.Resource.Demonstrate %></th>--%>
                                        <th><%=Resources.Resource.View %></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <asp:Repeater ID="ReptFormsQuestionsList" runat="server">
                                        <ItemTemplate>
                                            <tr scope="row">
                                                ...
                                                <td class="center">
                                                    <a class="btn btn-info btn-sm" href="FormView.aspx?FGID=<%# Eval("FormGuidID") %>"><%=Resources.Resource.View%></a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
