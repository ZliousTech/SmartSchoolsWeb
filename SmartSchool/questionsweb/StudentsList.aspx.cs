    ...
    public partial class StudentsList : System.Web.UI.Page
    {
        ...
        private void GetQuestionsList()
        {
            ...
            ReptQuestionsList.DataSource =
                SystemBase.GetDataTble($"SELECT DISTINCT QSA.FormGuidID, S.StudentID, StudentName = S.{StudentName}," +
                                       $"IsThereDeservedGrade = (SELECT COUNT(*) " +
                                       $"                        FROM QuestionStudentsDeservedGrade QSDAG " +
                                       $"                        WHERE QSDAG.StudentID = S.StudentID AND QSDAG.FormGuidID = QSA.FormGuidID)" +
