<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentQuestionsForms.aspx.cs" Inherits="SmartSchool.questionsweb.StudentQuestionsForms" %>
        ...
        <main class="body-container">
            <div class="inner-row">
                ...
                <div class="head-body-col">
                    <span>
                        <!-- back  icon-->
                        <a href="/" style="color: #fff"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                    </span>
                    <h2><%=Resources.Resource.StudentQuestionsForms %></h2>
                </div>
                            ...
                            <table class="table" id="exportTable" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><%=Resources.Resource.StartsAtExactly %></th>
                                        <th><%=Resources.Resource.EndsAtExactly %></th>
                                    ...
                                    <asp:Repeater ID="ReptFormsQuestionsList" runat="server">
                                        <ItemTemplate>
                                            <tr scope="row">
                                                ...
                                                <td><%# Eval("StratDateTime") %></td>
                                                <td><%# Eval("EndDateTime") %></td>
                                                <td class="center">
                                                    <%#Eval("IsFormOpened").ToString() == "FINISHED" 
                                                            ? 
                                                            "<a class='btn btn-warning btn-sm' href='javascript:0'>"+Resources.Resource.Finished+"</a>" 
                                                            :
                                                            Eval("IsFormOpened").ToString() == "CLOSED" 
                                                                ?
                                                                "<a class='btn btn-danger btn-sm' href='javascript:0'>"+Resources.Resource.Closed+"</a>"
                                                                :
                                                                Eval("IsFormOpened").ToString() == "YES" 
                                                                    ?
                                                                    "<a class='btn btn-info btn-sm' href='ViewStudentForm.aspx?FGID="+Eval("FormGuidID")+"'>"+Resources.Resource.Open+"</a>"
                                                                    :
                                                                    "<a class='btn btn-success btn-sm' href='javascript:0'>"+Resources.Resource.Wait+"</a>"
                                                    %>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
