...
function fGetGoogleObject(result, userContext) {
    ...
    if (result.Directions.Addresses.length > 1) {
        ...
        function computeTotalDistance(result) {
            ...
            //document.getElementById("total1").innerHTML = "total distance is: " + totalDist + " km <br /> total time is: " + (totalTime / 60).toFixed(2) + " minutes";
            //document.getElementById("totalDistance").innerHTML = totalDist + " km";
            //document.getElementById("totalDuration").innerHTML = (totalTime / 60).toFixed(2) + " mins";
            document.getElementById('hdntotalDistance').value = totalDist + " km";
            document.getElementById('hdntotalDuration').value = (totalTime / 60).toFixed(2) + " mins";
        }
    }
}
